...
--
-- Host: localhost:3306
-- Generation Time: Apr 28, 2021 at 10:02 PM
...
--
-- Table structure for table `ml_teamfranch`
--

DROP TABLE IF EXISTS `ml_teamfranch`;
CREATE TABLE IF NOT EXISTS `ml_teamfranch` (
  `franchID` text DEFAULT NULL,
  `franchName` text DEFAULT NULL,
  `active` text DEFAULT NULL,
  `NAassoc` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ml_teamfranch`
--

INSERT INTO `ml_teamfranch` (`franchID`, `franchName`, `active`, `NAassoc`) VALUES
