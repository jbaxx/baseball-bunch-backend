...
--
-- Table structure for table `teams_half`
--

DROP TABLE IF EXISTS `teams_half`;
CREATE TABLE IF NOT EXISTS `teams_half` (
  `COL 1` varchar(6) CHARACTER SET utf8 DEFAULT NULL,
  `COL 2` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
  `COL 3` varchar(6) CHARACTER SET utf8 DEFAULT NULL,
  `COL 4` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
  `COL 5` varchar(5) CHARACTER SET utf8 DEFAULT NULL,
  `COL 6` varchar(6) CHARACTER SET utf8 DEFAULT NULL,
  `COL 7` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
  `COL 8` varchar(2) CHARACTER SET utf8 DEFAULT NULL,
  `COL 9` varchar(2) CHARACTER SET utf8 DEFAULT NULL,
  `COL 10` varchar(2) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `teams_half`
--

INSERT INTO `teams_half` (`COL 1`, `COL 2`, `COL 3`, `COL 4`, `COL 5`, `COL 6`, `COL 7`, `COL 8`, `COL 9`, `COL 10`) VALUES
